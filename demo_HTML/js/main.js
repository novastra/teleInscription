...
//bouton FC refresh
$("#FCrefresh").click(function(){
    $("#educError").removeClass("error");
    $("#dip").removeClass("refus").addClass("accept");
}); 



//affichage bouton valider qu'après coche
$("#engagementHonneur").click(function(){
	$("#validationInscription").toggleClass("cachos");
});	
